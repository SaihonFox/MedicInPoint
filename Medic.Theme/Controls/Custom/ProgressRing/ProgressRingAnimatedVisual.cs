...
namespace Medic.Theme.Controls.Custom.ProgressRing;
...
public sealed class ProgressRingAnimatedVisual : Control
{
	...
	private CustomCompHandler _handler = null!;
	...
	private class HandlerMessage(HandlerMessageType type, object data)
	{
		public HandlerMessageType MessageType { get; } = type;
	...
	private class CustomCompHandler : CompositionCustomVisualHandler
	{
		...
		public override void OnRender(ImmediateDrawingContext drawingContext)
		{
			...
			var feat = (ISkiaSharpApiLeaseFeature)drawingContext.TryGetFeature(typeof(ISkiaSharpApiLeaseFeature))!;
